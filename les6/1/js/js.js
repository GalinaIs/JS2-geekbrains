...
FormValidation.prototype.validationName = function () {
    ...
    this.changeInformation(result, this.name, '*Имя должно содержать только буквы');
...
FormValidation.prototype.validationPhone = function () {
    ...
    this.changeInformation(result, this.phone, '*Телефон должен быть введен в формате: +7(000)000-0000');
...
FormValidation.prototype.validationEmail = function () {
    ...
    this.changeInformation(result, this.email, `*E-mail должен выглядеть как mymail@mail.ru, или my.mail@mail.ru, или 
    my-mail@mail.ru`);
...
FormValidation.prototype.validationDataBirth = function () {
    var result = this.dataBirth.val().length !== 0;
 ...
 */
FormValidation.prototype.changeInformation = function (flag, element, errorInfo) {
